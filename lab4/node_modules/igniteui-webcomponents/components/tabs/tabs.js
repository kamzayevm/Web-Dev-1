...
let IgcTabsComponent = IgcTabsComponent_1 = class IgcTabsComponent extends EventEmitterMixin(LitElement) {
    constructor() {
        ...
        this.handleKeyDown = (event) => {
            ...
            let index = enabledTabs.indexOf(document.activeElement?.closest('igc-tab'));
            switch (key) {
                case 'ArrowLeft':
                    index = ltr
    ...
    setupObserver() {
        ...
        this.mutationObserver = new MutationObserver(async (records, observer) => {
            observer.disconnect();
            const attributes = getAttributesForTags(records, 'igc-tab').filter((e) => e.closest(this.tagName)?.isSameNode(this));
