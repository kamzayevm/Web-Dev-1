...
let IgcSliderBaseComponent = class IgcSliderBaseComponent extends LitElement {
    ...
    constructor() {
        ...
        addKeybindings(this, {
            ...
            .set(homeKey, () => this.handleKeyboardIncrement(this.actualMin - this.activeValue))
            .set(endKey, () => this.handleKeyboardIncrement(this.actualMax - this.activeValue))
    ...
    handlePageKeys(delta) {
        const step = this.step ? this.step : 1;
        this.handleKeyboardIncrement(delta * Math.max((this.actualMax - this.actualMin) / 10, step));
    }
    ...
    renderThumb(value, ariaLabel, thumbId) {
      ...
      <div
        ...
        @blur=${() => (this.activeThumb?.part.remove('focused'),
