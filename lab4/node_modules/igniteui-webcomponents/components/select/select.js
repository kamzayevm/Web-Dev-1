...
let IgcSelectComponent = class IgcSelectComponent extends FormAssociatedRequiredMixin(EventEmitterMixin(IgcBaseComboBoxLikeComponent)) {
    ...
    handleSearch(event) {
        ...
        const item = this._activeItems.find((item) => item.textContent
            ?.trim()
            .toLocaleLowerCase()
...
IgcSelectComponent = __decorate([
    themes(all, true),
    blazorAdditionalDependencies('IgcIconComponent, IgcInputComponent, IgcPopoverComponent, IgcSelectGroupComponent, IgcSelectHeaderComponent, IgcSelectItemComponent')
], IgcSelectComponent);
